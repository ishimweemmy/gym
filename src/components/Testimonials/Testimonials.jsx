  ...
  return (
    <div className='Testimonials' id='testimonials'>
      <div className="left-t">
        ...
        <motion.span key={selected} initial={{opacity: 0, x: -100}} animate={{opacity: 1, x: 0}}  exit={{opacity: 0, x: 100}} transition={transition} >{testimonialsData[selected].review}</motion.span>
        <span>
